      ...
      >
        ...
        <div className='mb-6'>
          ...
          <input
            ...
            type='text'
            name='name'
            className='w-full px-6 py-4 border rounded-lg border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 bg-transparent text-gray-300'
        ...
        <div className='mt-4'>
          <button
            type='submit'
            className='w-full bg-primary text-white py-4 px-6 rounded-lg hover:bg-transparent hover:border hover:border-gray-300 transition duration-300'
